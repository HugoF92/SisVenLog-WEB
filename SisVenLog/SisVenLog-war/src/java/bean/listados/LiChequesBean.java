...
public class LiChequesBean {
    ...
    public void listarClientesBuscador() {
        try {
            ...
            System.out.println("todosCliente= " + todosCliente);
            System.out.println("codCliente= " + codCliente);
            System.out.println("nombreCliente= " + getNombreCliente());
            System.out.println("listaClientes= " + listaClientes);
        } catch (Exception e) {
    ...
    public void ejecutar(String operacion){
        try {
            ...
            if (operacion.equals("ARCH")) {
                ...
                String[] columnas = {"cod_banco", "xdesc_banco","nro_cheque", "xcuenta_bco", "fcheque", "icheque", "cod_cliente", "xnombre",
                ...
                rep.reporteLiCheques(sql, dateToString(getChequeDesde()), dateToString(getChequeHasta()), getBancos(), nomCli, operacion);
