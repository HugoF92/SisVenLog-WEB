 ...
 */
@Embeddable
public class CorteInventarioPK implements Serializable {
    ...
    public CorteInventarioPK() {
    }

    public CorteInventarioPK(short codEmpr, short codDepo, String codMerca, Date fmovim) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CorteInventarioPK)) {
            return false;
        }
        CorteInventarioPK other = (CorteInventarioPK) object;
    ...
    public String toString() {
        return "entidad.CorteInventarioPK[ codEmpr=" + codEmpr + ", codDepo=" + codDepo + ", codMerca=" + codMerca + ", fmovim=" + fmovim + " ]";
    }
