...
public class LlamarReportes {
    ...
    public void reporteLiRetornoPrecios(Integer cod_sublinea, String xsublinea, String desde, String hasta, String desde1, String hasta1, String usuImprime, String tipo) {
        try {

            Map param = new HashMap();
            param.put("cod_sublinea", cod_sublinea);
            param.put("xsublinea", xsublinea);
            param.put("desde", desde);
            param.put("desde1", desde1);
            param.put("hasta", hasta);
            param.put("hasta1", hasta1);
