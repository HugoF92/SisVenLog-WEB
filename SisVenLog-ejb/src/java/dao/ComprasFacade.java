...
public class ComprasFacade extends AbstractFacade<Compras> {
    ...
    //@elfedex : agrego para probar
    public List<CompraDto> comprasByNroFactu(String lNrofact) {
        List<CompraDto> lista = getEntityManager().createNativeQuery("SELECT ffactur, nrofact, cod_proveed, ctipo_docum, ttotal, isaldo, ccanal_compra, fvenc FROM compras WHERE cod_empr = 2 "
                + "AND ctipo_docum = 'FCC' AND nrofact = " + lNrofact, CompraDto.class).getResultList();
    ...
    public List<CompraDto> buscarFacturaCompraPorNroFactura(String lNrofact) {
...
/*
    public List<CompraDto> buscarFacturaCompraPorNroFacturaProveedor(long lNrofact, Short lCodProveed) {
