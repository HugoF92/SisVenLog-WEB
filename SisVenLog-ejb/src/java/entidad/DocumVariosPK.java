 ...
 */
@Embeddable
public class DocumVariosPK implements Serializable {
    ...
    public DocumVariosPK() {
    }

    public DocumVariosPK(short codEmpr, String ctipoDocum, int ndocum) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DocumVariosPK)) {
            return false;
        }
        DocumVariosPK other = (DocumVariosPK) object;
    ...
    public String toString() {
        return "entidad.DocumVariosPK[ codEmpr=" + codEmpr + ", ctipoDocum=" + ctipoDocum + ", ndocum=" + ndocum + " ]";
    }
