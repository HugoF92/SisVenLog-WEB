 ...
 */
@Embeddable
public class ExistenciasPK implements Serializable {
    ...
    public ExistenciasPK() {
    }

    public ExistenciasPK(short codEmpr, short codDepo, String codMerca) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ExistenciasPK)) {
            return false;
        }
        ExistenciasPK other = (ExistenciasPK) object;
    ...
    public String toString() {
        return "entidad.ExistenciasPK[ codEmpr=" + codEmpr + ", codDepo=" + codDepo + ", codMerca=" + codMerca + " ]";
    }
