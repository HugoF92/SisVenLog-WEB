...
public class ComprasDetPK implements Serializable {
    ...
    public ComprasDetPK(short codEmpr, String ctipoDocum, long nrofact, short codProveed, String codMerca, Date ffactur) {
    ...
    public String toString() {
        return "entidad.ComprasDetPK[ codEmpr=" + codEmpr + ", ctipoDocum=" + ctipoDocum + ", nrofact=" + nrofact + ", codProveed=" + codProveed + ", codMerca=" + codMerca + ", ffactur=" + ffactur + " ]";
    }
