 ...
 */
@Embeddable
public class NotasComprasDetPK implements Serializable {
    ...
    public NotasComprasDetPK() {
    }

    public NotasComprasDetPK(short codEmpr, short codProveed, String ctipoDocum, long nroNota, String codMerca, Date fdocum) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof NotasComprasDetPK)) {
            return false;
        }
        NotasComprasDetPK other = (NotasComprasDetPK) object;
    ...
    public String toString() {
        return "entidad.NotasComprasDetPK[ codEmpr=" + codEmpr + ", codProveed=" + codProveed + ", ctipoDocum=" + ctipoDocum + ", nroNota=" + nroNota + ", codMerca=" + codMerca + ", fdocum=" + fdocum + " ]";
    }
