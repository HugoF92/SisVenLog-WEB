 ...
 */
@Embeddable
public class PedComprasDetPK implements Serializable {
    ...
    public PedComprasDetPK() {
    }

    public PedComprasDetPK(short codEmpr, long nroPedido, String codMerca) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PedComprasDetPK)) {
            return false;
        }
        PedComprasDetPK other = (PedComprasDetPK) object;
    ...
    public String toString() {
        return "entidad.PedComprasDetPK[ codEmpr=" + codEmpr + ", nroPedido=" + nroPedido + ", codMerca=" + codMerca + " ]";
    }
