 ...
 */
@Embeddable
public class RetornosPreciosPK implements Serializable {
    ...
    public RetornosPreciosPK() {
    }

    public RetornosPreciosPK(short codEmpr, short codDepo, String codMerca, Character ctipoVta, Date frigeDesde) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof RetornosPreciosPK)) {
            return false;
        }
        RetornosPreciosPK other = (RetornosPreciosPK) object;
    ...
    public String toString() {
        return "entidad.RetornosPreciosPK[ codEmpr=" + codEmpr + ", codDepo=" + codDepo + ", codMerca=" + codMerca + ", ctipoVta=" + ctipoVta + ", frigeDesde=" + frigeDesde + " ]";
    }
