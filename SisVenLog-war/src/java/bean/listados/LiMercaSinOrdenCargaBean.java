...
@ManagedBean
@SessionScoped
public class LiMercaSinOrdenCargaBean {
    ...
    public LiMercaSinOrdenCargaBean() throws IOException {
    ...
    public void ejecutar(String tipo) {
        ...
        sql.append("AND (e.cant_cajas > 0 OR e.cant_unid > 0 ) AND NOT EXISTS ( SELECT *   \n"
                ...
                + " WHERE  mo.cod_empr = 2 and mo.fmovim BETWEEN ?l_finicial AND ?l_ffinal   \n"
