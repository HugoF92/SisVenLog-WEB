...
import dao.ListadoPedidosClientesFacade;
...
@ManagedBean
@SessionScoped
public class ListadoPedidosClientesBean implements Serializable{
    ...
    private List<Clientes> clientesSeleccionados;
    private List<Clientes> listadoClientes;
    
    @EJB
    private ListadoPedidosClientesFacade listadoPedidosClientesFacade;
    ...
    public void ejecutar(String tipo) {        
        if (validar()) {
            try {
                ...
                if (tipo.equals("VIST")) {
                    if (conDetalle) {
                        String nombreRepo = "listadoPedidoClienteDet";
                        String sql = armarSql(fechaPedidoDesde, fechaPedidoHasta, vendedor, canal, zona, nroPedidoDesde, nroPedidoHasta, seleccionFecha, seleccionTipo, conDetalle, clientesSeleccionados);
                        ...
                        String sqlDetalleDet = armarDetalleDet(fechaPedidoDesde, fechaPedidoHasta, vendedor, canal, zona, nroPedidoDesde, nroPedidoHasta, seleccionFecha, seleccionTipo, conDetalle);
                        rep.reporteLiPedidosCliente(sql, sqlDetalle, sqlDetalleDet, fechaPedidoDesde, fechaPedidoHasta, seleccionTipo, seleccionFecha, vendedor, canal, zona, FacesContext.getCurrentInstance().getExternalContext().getSessionMap().get("usuario").toString(), tipo, nombreRepo, "rdetpedidoscli", clientesSeleccionados);
                    }else { //sin detalle
                        String nombreRepo = "listadoPedidoCliente";
                        String sql = armarSql(fechaPedidoDesde, fechaPedidoHasta, vendedor, canal, zona, nroPedidoDesde, nroPedidoHasta, seleccionFecha, seleccionTipo, conDetalle, clientesSeleccionados);
                        String sqlDetalle = armarSqlDetalle(fechaPedidoDesde, fechaPedidoHasta, vendedor, canal, zona, nroPedidoDesde, nroPedidoHasta, seleccionFecha, seleccionTipo, conDetalle);
                        rep.reporteLiPedidosCliente(sql, sqlDetalle, null, fechaPedidoDesde, fechaPedidoHasta, seleccionTipo, seleccionFecha, vendedor, canal, zona, FacesContext.getCurrentInstance().getExternalContext().getSessionMap().get("usuario").toString(), tipo, nombreRepo, "rlispedidoscli", clientesSeleccionados);
                    }
                    ...
                    if (conDetalle) {
                       ...
                       lista = listadoPedidosClientesFacade.generarListadoPedidosExcel(fechaPedidoDesde, 
                                                                               fechaPedidoHasta, 
                                                                               vendedor, 
                                                                               canal, 
                                                                               zona, 
    ...
    public List<Clientes> getClientesSeleccionados() {
        return clientesSeleccionados;
    }

    public void setClientesSeleccionados(List<Clientes> clientesSeleccionados) {
