    ...
    public void ejecutar(String tipo) {        
        if (validar()) {
            try {
                ...
                if (tipo.equals("VIST")) {
                    if (conDetalle) {
                        String nombreRepo = "listadoPedidoDet";
                        ...
                        rep.reporteLiPedidos(sql, sqlDetalle, sqlDetalleDet, fechaPedidoDesde, fechaPedidoHasta, seleccionTipo, seleccionFecha, vendedor, canal, zona, FacesContext.getCurrentInstance().getExternalContext().getSessionMap().get("usuario").toString(), tipo, nombreRepo, "rdetpedidos");
                    }else { //sin detalle
                        String nombreRepo = "listadoPedido";
                        String sql = armarSql(fechaPedidoDesde, fechaPedidoHasta, vendedor, canal, zona, nroPedidoDesde, nroPedidoHasta, seleccionFecha, seleccionTipo, conDetalle);
                        String sqlDetalle = armarSqlDetalle(fechaPedidoDesde, fechaPedidoHasta, vendedor, canal, zona, nroPedidoDesde, nroPedidoHasta, seleccionFecha, seleccionTipo, conDetalle);
                        rep.reporteLiPedidos(sql, sqlDetalle, null, fechaPedidoDesde, fechaPedidoHasta, seleccionTipo, seleccionFecha, vendedor, canal, zona, FacesContext.getCurrentInstance().getExternalContext().getSessionMap().get("usuario").toString(), tipo, nombreRepo, "rlispedidos");
                    }
