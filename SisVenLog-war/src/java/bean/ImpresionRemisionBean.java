...
@ManagedBean
@SessionScoped
public class ImpresionRemisionBean {
    ...
    private AuxiliarImpresionRemisionDto auxiliarImpresionMasivaDto;
    private List<AuxiliarImpresionRemisionDto> listaAuxiliarImpresionMasivaDto;
    ...
    public ImpresionRemisionBean() throws IOException {
    ...
    public void impresion() {
        try {
            ...
            if (this.validarCorrelatividad()) {
                ...
                rep.impresionRemision(nroInicial, nroFinal);
    ...
    public void vistaPrevia() {
        try {
            ...
            if (this.validarCorrelatividad()) {
                ...
                //generamos los pdf para imprimir
                rep.vistaPreviaRemision(nroInicial, nroFinal);
    ...
    public AuxiliarImpresionRemisionDto getAuxiliarImpresionMasivaDto() {
        return auxiliarImpresionMasivaDto;
    }

    public void setAuxiliarImpresionMasivaDto(AuxiliarImpresionRemisionDto auxiliarImpresionMasivaDto) {
        this.auxiliarImpresionMasivaDto = auxiliarImpresionMasivaDto;
    }

    public List<AuxiliarImpresionRemisionDto> getListaAuxiliarImpresionMasivaDto() {
        return listaAuxiliarImpresionMasivaDto;
    }

    public void setListaAuxiliarImpresionMasivaDto(List<AuxiliarImpresionRemisionDto> listaAuxiliarImpresionMasivaDto) {
    ...
    public boolean validarCorrelatividad() {
        ...
        try {
            ...
            this.listaAuxiliarImpresionMasivaDto = personalizedFacade.listarSecuenciasRemision(nroInicial, nroFinal);
